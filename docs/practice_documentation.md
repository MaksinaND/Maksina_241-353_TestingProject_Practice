...
![](PNETLab/lab5_1_4.png)

1.6 Запустим `Yersinia`
![](PNETLab/lab5_1_5.png)
...
![](PNETLab/lab6_2_1.png)
![](PNETLab/lab6_2_1__.png)
![](PNETLab/lab6_2_1_.png)

2.2 Теперь при попытках атак видим, что защита полностью сработала и функционирует.

![](PNETLab/lab6_2_2.png)
